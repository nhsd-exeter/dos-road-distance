...
class StepLoadShape(LoadTestShape):
    stages = [
        {"duration": 300, "users": 150, "spawn_rate": 10, "request_file": "ccs_5_destinations.json"},
        {"duration": 600, "users": 120, "spawn_rate": 10, "request_file": "ccs_50_destinations.json"},
        {"duration": 900, "users": 90, "spawn_rate": 10, "request_file": "ccs_500_destinations.json"},
        {"duration": 1200, "users": 60, "spawn_rate": 10, "request_file": "ccs_1500_destinations.json"},
        {"duration": 1500, "users": 30, "spawn_rate": 10, "request_file": "ccs_3000_destinations.json"},
    ]
